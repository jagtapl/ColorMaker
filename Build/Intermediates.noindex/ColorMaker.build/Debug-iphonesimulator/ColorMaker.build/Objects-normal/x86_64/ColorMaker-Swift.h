...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ColorMaker",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10ColorMaker11AppDelegate")
...
SWIFT_CLASS("_TtC10ColorMaker13SceneDelegate")
...
SWIFT_CLASS("_TtC10ColorMaker14ViewController")
